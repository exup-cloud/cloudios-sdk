                      ...
                      rect:(CGRect)rect;
{
    ...
    [self drawline:context startPoint:CGPointMake(self.contentLeft,(self.uperChartHeightScale * self.contentHeight)/2.0 + self.contentTop) stopPoint:CGPointMake(self.contentRight, (self.uperChartHeightScale * self.contentHeight)/2.0 + self.contentTop) color:GARY_BG_TEXT_COLOR lineWidth:self.borderWidth/2.0];
    
}

- (void)drawLabelPrice:(CGContextRef)context {
    UIColor * labelBGColor = [UIColor clearColor];// [UIColor colorWithWhite:1.0 alpha:0.3]; // label 背景颜色
    ...
    [maxPriceAttStr addAttribute:NSForegroundColorAttributeName value:UP_WARD_COLOR  range: NSMakeRange(0, maxPriceAttStr.length)];
    ...
    [midPriceAttStr addAttribute:NSForegroundColorAttributeName value:[UIColor grayColor]  range: NSMakeRange(0, midPriceAttStr.length)];
    ...
    [minPriceAttStr addAttribute:NSForegroundColorAttributeName value:DOWN_COLOR  range: NSMakeRange(0, minPriceAttStr.length)];
