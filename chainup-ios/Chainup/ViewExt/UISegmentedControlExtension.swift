...
extension UISegmentedControl  {
    ...
    public func extAddBottomLine(_ color :UIColor , moveLineColor : UIColor , selIndex : Int , itemsCount : Int){
        ...
        self.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "H:|[bottomLine]|", options: NSLayoutFormatOptions(), metrics: nil, views: ["bottomLine" : bottomLine]))
        
        self.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:[bottomLine(1)]|", options: NSLayoutFormatOptions(), metrics: nil, views: ["bottomLine" : bottomLine]))
