...
@objc public protocol EXExpandTextViewDelegate: UITextViewDelegate {
    @objc optional func textViewDidChangeHeight(_ textView: EXExpandTextView, height: CGFloat)
}

@IBDesignable @objc
open class EXExpandTextView: UITextView {
    ...
    override open func layoutSubviews() {
        ...
        if height != heightConstraint!.constant {
            ...
            if let delegate = delegate as? EXExpandTextViewDelegate {
    ...
    @objc func textDidEndEditing(notification: Notification) {
        if let sender = notification.object as? EXExpandTextView, sender == self {
