...
public class MD5: NSObject {
    /*
    获得小写MD5加密 16
    */
    public class func getmd5(_ str:String?) ->String{
        guard let convertString = str else {
            return ""
        }
        
        let bytes = [Byte](convertString.utf8)
        let digest = md5(bytes)
        return encodeMD5(digest: digest.digest)
    }
    ...
    public class func getMD5(_ str:String?) ->String{
        ...
        let lowermd5 = self.getmd5(convertString)
        return lowermd5.uppercased()
    }
}
